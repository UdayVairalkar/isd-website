  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-6">
        ...
        <p className="opacity-0 animate-fade-up-delay-1 font-display text-2xl md:text-3xl font-light tracking-wide mb-3" style={{ color: "hsl(40 30% 95%)", textShadow: "0 2px 10px rgba(0,0,0,0.5)" }}>
